...
// Auto-playing video as requested by user
    ...
    <div className="relative w-full" style={{ aspectRatio: '16/9' }}>
      ...
      {!isLoaded && (
        <img
          src={poster}
          alt="Loading video..."
          className="absolute inset-0 w-full h-full object-cover rounded-[1.4rem] md:rounded-[2.4rem]"
        />
      )}
      ...
      {/* Small loading indicator in corner while downloading */}
      {!isLoaded && (
